...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center border-b-2 border-slate-400 px-1 pt-1 text-sm font-medium leading-5 text-gray-900 transition duration-150 ease-in-out focus:border-slate-700 focus:outline-none'
